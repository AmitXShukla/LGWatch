...
class PromptState extends State<Prompt> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: const Text("LG/Watch.Out", style: cHeaderText)),
        body: Padding(
    ...
    return Form(
      ...
      child: SingleChildScrollView(
        child: Center(
          child: Column(
            children: <Widget>[
              const Text("ask LG", style: cHeaderText),
              const SizedBox(
                width: 10,
                height: 20,
              ),
                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text(
                              "**in demo version, your prompts are NOT saved anywhere.** In production, Your prompts are stored in history for 7 days, please delete those anytime you want.")));
                    },
                  ),
                  IconButton(
