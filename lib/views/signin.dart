        ...
        child: Center(
          child: Column(
            children: <Widget>[
              ...
              const Text("Demo : shukla@duck.com Password1", style: cHeaderText),
              const SizedBox(
                width: 10,
                height: 20,
              ),
              ...
              GestureDetector(
                ...
                onTap: () {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text(
                              "Social auth login intentionally disabled in demo app.")));
                    },
                child: Chip(
    ...
    return Center(
      child: Column(
        children: [
          ...
          ElevatedButton(
            child: Text(AppLocalizations.of(context)!.cSettings1),
            // color: Colors.blue,
            onPressed: () {
              Navigator.pushNamed(
                context,
