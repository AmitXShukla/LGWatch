                  ...
                  IconButton(
                    ...
                    onPressed: () {
                      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                          content: Text(
                              "Your device data is fetch through your API provider. Please set up API to allow accessing your sensors. Your Device data is futher read into AI Engine for assessments and your personal alerts are shown based on AI/Device data inference.")));
                    },
                  ),
                  const SizedBox(
                    width: 10,
